...
const SearchPage = () => {
  ...
  useEffect(() => {
    ...
    if (categoryParam && shopParam) {
      fetchMerchandises(query, categoryIds, shopIds);
    } else if (categoryParam) {
      fetchMerchandises(query, categoryIds, selectedShops);
    } else if (shopParam) {
      fetchMerchandises(query, selectedCategories, shopIds);
    } else {
                      ...
                      <div>
                        ...
                        <p className="text-base font-semibold text-emerald-800">
                          ...
                          merch.variants[0].sizes.length > 0
                            ? `${merch.variants[0].sizes[0].original_price}`
                        ...
                        <p>
                          ...
                          <span className="font-semibold text-emerald-800">
                            ...
                            {merch.variants[0].sizes &&
                            merch.variants[0].sizes.length > 0
                              ? `${merch.variants[0].sizes[0].membership_price}`
